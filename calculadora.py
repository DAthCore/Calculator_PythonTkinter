...
class Calculadora(tk.Tk): #Definimos clase, heredamos de la clase Tk
    def __init__(self): #DEfinimos el metodo init
        super().__init__() #Mandamos llamar el constructir de la clase padre (tk)
        self.geometry('400x450')
        self.resizable(0,0) #No se modifica el tamaño de la ventana
        ...
        #Caja de texto (input)
        self.entrada = None
        #StrinVar lo utilzamos oara obtener el valor del input
    ...
    def _creacion_componentes(self):
        ...
        #Creamos el frame para la parte inferior
        ...
        #Parametro Lambda: Cuando se define una función anonima
        ...
        #Quinto Renglón
        boton_cero = tk.Button(botones_frame, text='0', width=10, height=3, bd=0, bg='#fff', cursor='hand2', command=lambda:self._evento_click(0))
    ...
    def _evento_evaluar(self):
        ...
        #Agregamos un Try Catch, para el manejo de excepciones:
        #Si hay una excepción o no, la expresi+on la vamos a convertir de cualquier manera a cadena vacía.
        try:
    ...
    def _evento_click(self, elemento):
        #Concatenamos el nuevo elmento a la expresión ya existente
        self.expresion = f'{self.expresion}{elemento}'
        self.entrada_texto.set(self.expresion)

if __name__ == '__main__': #Preguntasmos si se esta ejecutando la aplicación desde este archivo
    calculadora = Calculadora() #Se crea el objeto
    calculadora.mainloop() #Llamamos metodo main, se hereda de la clse TK
